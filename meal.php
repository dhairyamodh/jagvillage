...
<head>
  ...
  <!-- /.modal-dialog -->
        ...
        <span class="visible-xs-inline"></span></div><div class="col-sm-4 col-sm-offset-0 col-xs-offset-4 col-xs-8"><a class="btn btn-primary btn-block" href="volunteer.php?key=<?php echo $key; ?>&date=<?php echo $row_cate['date']; ?>">Volunteer for this</a></div></div>
        </a>
        <?php }else{ ?>
        <strong class="text-danger">This date is unavailable</strong>
        <span class="visible-xs-inline"></span></div><div class="col-sm-4 col-sm-offset-0 col-xs-offset-4 col-xs-8"><a class="btn btn-primary btn-block" href="volunteer.php?key=<?php echo $key; ?>&date=<?php echo $row_cate['date']; ?>" disabled>Volunteer for this</a></div></div>
        <?php } ?>
                        <?php } ?>
    </div>
					</div>
