  ...
  if (!empty($_SESSION['email'])) {
    ...
    <section id="about">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <div class="panel-body">
                <div>
                  ...
                  ?>
                    <div class="row">
                      <div class="col-sm-3 col-xs-4 text-center">
                        <h6><?php echo date('F j Y', strtotime($row_cate['date'])); ?></h6><?php echo date('l', strtotime($row_cate['date'])); ?>, <?php echo $row_cate['time_one'] ?> to <?php echo $row_cate['time_two'] ?>
                      </div>
                      ...
                      <div class="col-sm-4 col-sm-offset-0 col-xs-offset-4 col-xs-8"><a class="btn btn-primary btn-block cancel_meal" cate_id="<?php echo $row_cate['date']; ?>" date="<?php echo $row_cate['date']; ?>">Cancel Service</a></div>
                    </div>
                  <?php } elseif (!empty($c_row['vol_email']) && $c_row['vol_email'] == $email && $c_row['cate_id'] == $row_cate['cate_id']) { ?>
                    ...
                    <span class="visible-xs-inline"></span></div>
                <div class="col-sm-4 col-sm-offset-0 col-xs-offset-4 col-xs-8"><a class="btn btn-secondary btn-block" href="change-volunteer.php?id=<?php echo $row_cate['cate_id']; ?>">Make Changes</a></div>
              </div>
            <?php } else { ?>
            ...
            <div class="col-sm-4 col-sm-offset-0 col-xs-offset-4 col-xs-8"><a class="btn btn-primary btn-block" href="volunteer.php?id=<?php echo $row_cate['cate_id']; ?>">Volunteer for this</a></div>
          </div>
          </a>
      <?php }
                          } ?>
      <?php } else {
        ...
        <div class="col-sm-4 col-sm-offset-0 col-xs-offset-4 col-xs-8"><a class="btn btn-primary btn-block cancel_meal" cate_id="<?php echo $row_cate['cate_id']; ?>" date="<?php echo $row_cate['date']; ?>">Cancel Service</a></div>
      </div>
    <?php
                          } else {
    ?>
