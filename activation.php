				...
				<div class="row">
					<div class="card col-md-12" style="border: 1px solid #1c1c1c; padding: 20px; border-radius: 10px;">
						...
						<div class="card-body text-center">
							...
							<a href="https://www.facebook.com/sharer/sharer.php?u=http://jagvillage.com/jagvillage-service.php?key=<?php echo $_GET['key']; ?>&t=TITLE" class="btn btn-info" target="_blank"><i class="fa fa-facebook-square" aria-hidden="true"></i> Share on facebook</a>
