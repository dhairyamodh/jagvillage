    ...
    <section id="slider">
        <div class="owl_slider top_slider_wrap">
            <ul class="owl-carousel top_slider">
                <li class="style-1" style="background-image: url(https://via.placeholder.com/1920x1080);">
                                    ...
                                    <ul class="owl-carousel projects_slider">
                                        ...
                                        <li>
                                            <div class="row" style="padding-left: 10px; padding-right: 10px;">
                                                <div class="col-md-6">
                                                    <img src="https://via.placeholder.com/800x300" style="border:1px solid #159397; border-radius: 25px; object-fit: cover;" />
                                                </div>
