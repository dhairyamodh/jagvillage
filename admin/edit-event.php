...
if (!empty($_SESSION['admin_email'])) {
   ...
   if (isset($_POST['add-event'])) {
      ...
      $id = $_POST['id'];
      $img = $_POST['filename'];
      $sql = "update event set event_date='$date',event_name='$title',event_img='$img',event_desc='$desc' where event_id='$id'";
      ...
      if ($run) {
         ...
         $msg = '<div class="alert alert-danger">Event Not Updated</div>';
      }
   }
?>
   <!DOCTYPE html>
                     ...
                     <div class="d-flex justify-content-between">
                        <div class="clearfix">
                           <div class="pd-t-5 pd-b-5">
                              <h1 class="pd-0 mg-0 tx-20 tx-dark">Edit Event</h1>
                           </div>
                        ...
                        <div class="card mg-b-30">
                           <div class="card-header">
                              <div class="d-flex justify-content-between align-items-center">
                                 <div>
                                    <h6 class="card-header-title tx-13 mb-0">Edit Event Form</h6>
                                 </div>
                           ...
                           <div class="card-body">
                              ...
                              ?>
                              <form action="edit-event.php?event_id=<?php echo $id; ?>" method="POST" data-parsley-validate>
                                 ...
                                 <div class="row mg-b-15">
                                    ...
                                    <div class="col-lg-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" name="title" class="form-control" placeholder="Enter event title" required value="<?php echo $title; ?>">
                                       </div>
                                    </div>
                                    <!-- col-4 -->
                                    <div class="col-lg-3">
                                       <div class="form-group mg-b-10-force">
                                          ...
                                          <input type="text" autocomplete="off" class="form-control" name="date" placeholder="Choose date" required="" value="<?php echo $date; ?>">
                                       </div>
                                    </div>
                                    <div class="col-lg-3">
                                       <div class="form-group mg-b-10-force">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="form-group mg-b-10-force">
                                          ...
                                          <textarea name="desc" class="form-control" placeholder="Enter event description" required rows="10" cols="3"><?php echo $desc; ?></textarea>
                                       </div>
                                    </div>
                                    <!-- col-4 -->
                                 </div>
                                 <!-- d-flex -->
                                 <button type="submit" name="add-event" class="btn btn-primary">Edit Event</button>
      ...
      $(document).ready(function() {
         $(document).on('change', '#file', function() {
            ...
            if (fsize > 2000000) {
               ...
               form_data.append('edit_event_img', 1);
               form_data.append('event_id', $('input[name="id"]').val());
