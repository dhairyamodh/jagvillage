                        ...
                        <div class="ourpoints">
                        	<div class="row point">
	                        	...
	                        	<div class="text-space text">
	                        		<p style="text-align:justify; font-weight: 600;">J.A.G. Village is dedicated to providing support, a sense of community and empowering children and their families who are anticipating or have experienced the loss of a loved one through counselling, grief education and collective healing activities.</p>
	                        	</div>
	                        </div>	                        
	                        <h3>Our Vision</h3>
	                        <div class="row point">
	                        	...
	                        	<div class="text-space text">
	                        		<p style="text-align:justify; font-weight: 600;">To promote and create a culture both internally and externally of J.A.G. Village where individuals, families and communities recognize that grief is not a problem to be solved, it is love that needs to be honoured.</p>
	                        	</div>
	                        </div>
                        </div>
					</div>
							...
							<ul class="owl-carousel projects_slider">
								...
								<div class="row" style="padding-left: 10px; padding-right: 10px;">
									...
									<div class="col-md-6">
										...
										<a href="https://jagvillage.janeapp.com/" class="btn btn-primary" target="_blank" >Book Now</a><a href="http://test.jagvillage.com/service.php" class="btn btn-secondary">Learn More</a>
									</div>
								</div>
						...
						<div class="events-wrap">
							...
							<div class="event-item">
								...
								<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 event-info">
									...
									<p><font color="white"><a href="event.php?event_id=<?php echo $row['event_id']; ?>"class="color-bg">More Details</a></font></p>
								</div>
							</div>
							<?php } ?>
						</div>
