...
<head>
  ...
  <!-- /.modal-dialog -->
    ...
    $mail_rec->addAddress($row_data['recipent_email']);      //Adds a "To" address
...
// 	} 
    ...
    $mail_org->addAddress($row_org['user_email']);      //Adds a "To" address
                ...
                <div class="panel panel-default">
				    ...
				    <div class="row">
					    ...
					    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 sendmessage">
					    	<!-- Start contact form -->
					    	<form class="cmxform" action="volunteer.php?id=<?php echo $id; ?>" method="post">
					    		<label for="date">Date</label>
					    		<input id="date" type="text" name="date" value="<?php echo $date; ?>" readonly>
					    		<label for="vol">Volunteer</label>
								<input id="date" type="text" name="vol" value="<?php echo $fname.' '.$lname ?>" readonly>
					    		...
					    		<input id="check" type="checkbox" name="remainder" placeholder="Optional" value="yes">
                                <label for="check">One day before</label>
								<br>
                                <input type="hidden" name="token" value="<?php echo $key; ?>">
                                <button class="btn btn-primary" type="submit" name="volunteer"><i class="fa fa-check"></i> Volunteer</button>
                                </form>
